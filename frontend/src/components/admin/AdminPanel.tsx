                ...
                <div className="border-2 rounded-lg p-6 bg-white">
                  ...
                  <div className="mt-6">
                    ...
                    <input
                      ...
                      min={0}
                      max={365}
                      value={onboardingSettings.trial_premium_days}
                      onChange={(e) => setOnboardingSettings({ ...onboardingSettings, trial_premium_days: Math.max(0, Math.min(365, parseInt(e.target.value, 10) || 0)) })}
                      placeholder="10"
                      className="w-full px-4 py-2 border border-gray-300 rounded"
                    />
                    <p className="text-xs text-gray-500 mt-1">
