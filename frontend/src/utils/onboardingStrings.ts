...
export const welcomeModal = {
  ...
  bullets: [
    ...
    'Two table types: Day tables (scheduled) + TODO tables (unscheduled).',
...
export const tutorialSteps: TutorialStep[] = [
  ...
  },
  {
    ...
    text: 'Use the dropdown at the bottom to switch between your Day and TODO tables.',
    textMobile: 'Use the dropdown at the bottom to switch between your Day and TODO tables.',
    target: 'tutorial-table-dropdown',
    targetMobile: 'tutorial-table-dropdown',
    isInfoStep: false,
  },
  {
    title: 'Pull a TODO into your schedule',
    text: 'Move a task from TODO into the Day table to schedule it.',
    textMobile: 'Long-press the task name, then choose the Day table to schedule it.',
    target: 'task-email-triage-name',
    isInfoStep: false,
  },
  {
    title: 'Push it back to TODO',
    text: 'Move a task from the Day table back into TODO to unschedule it.',
    textMobile: 'Long-press the task name, then choose the TODO table to unschedule it.',
    target: 'task-email-triage-name',
    isInfoStep: false,
  },
  {
